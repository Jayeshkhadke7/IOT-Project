...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.umair.beacons_plugin.BeaconsPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin beacons_plugin, com.umair.beacons_plugin.BeaconsPlugin", e);
    }
    try {
